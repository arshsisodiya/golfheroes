...
export default function DashboardPage() {
  ...
  return (
    <div style={{ padding: '32px 28px', maxWidth: 1100 }}>
      ...
      {!isActive && (
        <div style={{ background: 'rgba(244,63,94,0.08)', border: '1px solid rgba(244,63,94,0.2)', borderRadius: 12, padding: '18px 20px', marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <div>
      ...
      {loading ? (
        ...
        <>
          <div className="card" style={{ marginBottom: 24, background: 'linear-gradient(135deg, var(--surface) 0%, #111a10 100%)', border: '1px solid rgba(200,241,53,0.12)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16, flexWrap: 'wrap', marginBottom: 18 }}>
              <div>
                <div className="badge badge-dim" style={{ marginBottom: 10 }}>Next steps</div>
            ...
            <div className="grid-3">
              {nextSteps.map((step) => (
                <div key={step.key} style={{ background: 'var(--surface-2)', borderRadius: 12, padding: 16, border: `1px solid ${step.done ? 'rgba(45,212,191,0.18)' : 'var(--border)'}` }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 20 }}>
            ...
            <div className="card" style={{ background: 'linear-gradient(135deg, var(--surface) 0%, #141a0e 100%)', border: '1px solid rgba(200,241,53,0.1)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 18 }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10, marginBottom: 20 }}>
                    {[
                      ...
                      <div key={label} style={{ background: 'var(--surface-2)', borderRadius: 10, padding: '12px', textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: '0.65rem', color: 'var(--text-3)', marginTop: 2, lineHeight: 1.3 }}>{label}</div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="card">
              ...
              {charity ? (
                ...
                <div style={{ textAlign: 'center', padding: '20px 0', color: 'var(--text-3)', fontSize: '0.85rem' }}>
                  No charity selected
                  <br /><Link to="/settings" className="btn btn-outline btn-sm" style={{ marginTop: 10 }}>Choose Charity</Link>
                </div>
              )}
            </div>
